...
var ASM_CONSTS = {
  3870736: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3870791: ($0) => { performance.now = function() { return $0; }; },  
 3870839: ($0) => { performance.now = function() { return $0; }; },  
 3870887: () => { performance.now = Module['emscripten_get_now_backup']; }
};
